  ...
  return (
    ...
    <form onSubmit={authUser} className="mt-8 flex justify-center items-center flex-col">
      ...
      <input
        ...
        onChange={pwChange}
      />
      <button disabled={!email || !password} type="submit" className="disabled:opacity-40 mt-5 py-1 px-3 text-white bg-indigo-600 hover:bg-indigo-700 rounded focus:outline-none">
